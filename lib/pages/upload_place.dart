      ...
      body: Form(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              TextFormField(
                decoration:
                    inputDecoration('Nome do Item', 'Nome do Item', nameCtrl),
                controller: nameCtrl,
                validator: (value) {
              ...
              TextFormField(
                decoration: inputDecoration(
                    'URL do Thumbnail', 'Imagem 1(Thumbnail)', image1Ctrl),
                controller: image1Ctrl,
                validator: (value) {
                  if (value!.isEmpty) return 'Valor está vazio';
                  return null;
                },
              ),
              SizedBox(
              ...
              TextFormField(
                decoration:
                    inputDecoration('URL da Imagem', 'Imagem 2', image2Ctrl),
              ...
              TextFormField(
                decoration:
                    inputDecoration('URL da Imagem', 'Imagem 3', image3Ctrl),
              ...
              TextFormField(
                decoration: InputDecoration(
                    hintText: 'Detalhes do Item (Html ou texto normal)',
                    border: OutlineInputBorder(),
                    labelText: 'Detalhes do Item',
                    contentPadding:
